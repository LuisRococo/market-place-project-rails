...
import { verifyAndSetFieldErrors } from "../components/shared/helpers";
...
class EditProductForm extends Component {
  ...
  render() {
    const buttonText = "UpdateProduct";
...
const ImprovedComponent = withProductForm(EditProductForm);

export default (props) => {
  let navigate = useNavigate();
  return (
    <ImprovedComponent {...props} params={useParams()} navigate={navigate} />
  );
};
